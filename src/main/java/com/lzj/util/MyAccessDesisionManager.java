...
public class MyAccessDesisionManager implements AccessDecisionManager {
    ...
    public void decide(Authentication authentication, Object object, Collection<ConfigAttribute> configAttributes) throws AccessDeniedException {
            ...
            Iterator<? extends GrantedAuthority> authorityIterator=authentication.getAuthorities().iterator();
            boolean flag=false;
            while (iterator.hasNext()){
                ConfigAttribute configAttribute=iterator.next();
                while (authorityIterator.hasNext()){
                   SimpleGrantedAuthority authority= (SimpleGrantedAuthority) authorityIterator.next();
